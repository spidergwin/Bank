...
import { IconEye, IconEyeOff, IconLoader2, IconCheck, IconAlertCircle, IconMailForward } from "@tabler/icons-react";
...
export function RegisterForm() {
  ...
  if (isSuccess) {
    return (
      <div className="flex flex-col items-center justify-center space-y-6 animate-in fade-in zoom-in-95 duration-500 min-h-[60vh]">
